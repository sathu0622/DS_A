    ...
    const fetchStatus = async () => {
      try {
        const res = await axios.get(
          `http://food-app.127.0.0.1.nip.io/api/orders/order/${orders.orders._id}`
        );
    ...
    const fetchLocations = async () => {
      try {
        const res = await axios.get(
          ...
          {
            params: {
              restaurantId: orders.orders.restaurantId,
              userId: orders.orders.userId,
            },
          }
        );
